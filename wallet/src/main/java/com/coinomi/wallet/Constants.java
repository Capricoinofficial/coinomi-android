...
import com.coinomi.core.coins.CapricoinMain;
...
public class Constants {
    ...
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
			...
			new CoinAddress(CapricoinMain.get(),    new ServerAddress("electrum1.capricoin.org", 50011),
                                                    new ServerAddress("electrum1.capricoin.org", 50011))
    );
...
//        COINS_ICONS.put(CoinID.URO_MAIN.getCoinType(), R.drawable.uro);
		...
		COINS_ICONS.put(CoinID.CAPRICOIN_MAIN.getCoinType(), R.drawable.capricoin);
...
//        COINS_BLOCK_EXPLORERS.put(CoinID.URO_MAIN.getCoinType(), "https://chainz.cryptoid.info/uro/tx.dws?%s");
		...
		COINS_BLOCK_EXPLORERS.put(CoinID.CAPRICOIN_MAIN.getCoinType(), "https://insight.capricoin.org/tx/%s");
    }
